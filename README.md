...
```
def​​get_bill​(​room_type, from_date, to_date, season_coef, category_coef​): 
      List<Integer> days_count = new ArrayList<>(7)
      Int bill = 0
...
```
insert​ ​into
      ​`hotel_chain`​.​`books`​(​`bill`​, ​`from_date`​, ​`to_date`​, ​`roomid`​, ​`userid`​, `num_of_guests`​) 
values
      ...
      where
            ...
            (
                  ...
                  ​where
                        ...
                        ​and
                        (
                              B.from_date ​between​​'2020-12-26'​​and​​'2020-12-28' 
                              ​or​B.to_date ​between​​'2020-12-26'​​and​​'2020-12-28' 
                              ​or​(B.from_date <= ​'2020-12-26'​​and​B.to_date >= ​'2020-12-28'​)
                        )
            );
```
...
```
insert into
      `hotel_chain`​.​`guest`​(​`id`​,​`first_name`​, ​`last_name`​, ​`address`​, ​`id_type`​, `id_number`​, ​`mobile_phohe_number`​, ​`home_phone_number`​, ​`books_id`​) 
values
...
from
      ...
      ​inner​ ​join
            books
            ​on​books.id = guest.books_id 
      ​inner​ ​join
            rooms
            ​on​books.roomid = rooms.id 
            ​and​books.from_date <= ​'2020-10-15' 
            ​and​books.to_date >= ​'2020-10-15' 
            ​and​rooms.number = ​311​;
```
            ...
            ​from 
                  (
                        ...
                        ​from
                              ...
                              ​join
                                    ​`hotel_chain`​.​`user_categories`​UC 
                                    ​on​U.user_categoryid = UC.user_categoryid
                              ​where
                                    UC.name = ​'bronze' 
                                    ​and​B.from_date > ​'2020-01-01'
                              ​group​ 
                                    ​by U.id
                  )
                  ​as​T 
